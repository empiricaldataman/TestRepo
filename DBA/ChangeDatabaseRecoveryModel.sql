/*-----------------------------------------------------------------------------------------------
        NAME: ChangeDatabaseRecoveryModel.sql
 MODIFIED BY: Sal Young
       EMAIL: saleyoun@yahoo.com
 DESCRIPTION: Use this script to change the recovery model to simple on all databases in a SQL
              instance. Normally used in lower environments where backups are not necessary.
-------------------------------------------------------------------------------------------------
         DATE MODIFIED      DESCRIPTION   
-------------------------------------------------------------------------------------------------
   06.17.2014 SYoung        Initial creation.
-------------------------------------------------------------------------------------------------
