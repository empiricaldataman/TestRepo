/*-----------------------------------------------------------------------------------------------
        NAME: RemoveOrphanUser.sql
 MODIFIED BY: Sal Young
       EMAIL: saleyoun@yahoo.com
 DESCRIPTION: Use this script to remove orphan users from all databases in a SQL instance. It  
              will also transfer ownership of db objects and schemas to dbo.
-------------------------------------------------------------------------------------------------
