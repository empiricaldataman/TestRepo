/*-----------------------------------------------------------------------------------------------
 ...
 DESCRIPTION: Use this script to find all references to and from a database object.  This script
              ...
              http://sqlblog.com/blogs/tamarick_hill/archive/2013/05/07/sql-dependency-dmv-s.aspx
...
SELECT A.referencing_schema_name [ReferencingSchema]
  ...
  FROM sys.dm_sql_referencing_entities('<FileLogicName, sysname, FileLogicName>','OBJECT') A
...
SELECT DISTINCT B.type_desc [ReferencedType]
  ...
  FROM sys.dm_sql_referenced_entities('<FileLogicName, sysname, FileLogicName>','OBJECT') A
